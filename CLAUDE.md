...
- **Mixed data types in `Route No`**: stored as string, integer, **and float** in different rows — even within the same file (e.g. MADURAI mixes all three: `'2K'`, `504`, `146.0`). Must be cast to string consistently in Silver layer.
